...
function generate( docType, title, docs, filename, resolveLinks ) {
	...
	// let's try the easy way first. I'm sure this will break something :(
	html = html.replace(/&lt;static>/g, "");
	html = html.replace(/module:\w+\/\w+\./g, "");
	html = html.replace(/(module): (\w+)\/(\w+)/ig, "$1: $2.$3");
	html = html.replace(/module:\w+\.(\w+)/g, "$1");

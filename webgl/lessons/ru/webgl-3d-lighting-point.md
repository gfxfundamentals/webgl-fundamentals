...
в степень негативного значения не определено, что не очень-то хорошо.
...
<p>Как понять, будет ли результат положительным или отрицательным? Я не особо силён в математике,
но это кажется неразрешимым и, следовательсно, неопределённым.</p>
</div>

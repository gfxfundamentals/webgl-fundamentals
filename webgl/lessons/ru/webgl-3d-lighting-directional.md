...
Сначала в вершинном шейдере нам нужно передать нормали далее
...
Теперь при повороте F подсвечиваются те грани, которые направлены на свет.
...
{{{diagram url="resources/normals-scaled.html" caption="кликните для переключения нормалей" }}}
...
Кликните на картинке, чтобы убрать нормали. Вы увидите, что освещение
на двух крайних сферах очень отличается, так как используются разные
матрицы. Сложно сказать, какое из них правильное, так как отличие
едва различимо.
